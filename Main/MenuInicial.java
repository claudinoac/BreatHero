...
public class MenuInicial extends JFrame 
{
	...
	public MenuInicial()
	{
		...
		this.setResizable(false);           //Seta que esse frame não serão redimensionável
	...
	private void addListeners()   //Adiciona listeners ao frame e aos botões
	{
		...
		botoes[0].addActionListener(new ActionListener()  //Adiciona listener ao botão "novo jogo"
		{
			...
			public void actionPerformed(ActionEvent e)  
			{
				...
				pressedFlag = true;						  //Seta flag de pressionamento de botï¿½o para uma variável que será lida externamente através de seu getter
			}
		});
	...
	public JPanel criaPainelPrincipal()   //Instancia componentes gráficos e retorna um painel com eles
	{
		...
		g.insets = new Insets(0,0,60,0);						   //Configura espaï¿½amento entre os setores norte e centro do GridBag
		...
		g.gridy = 1;											   //Aloca o painel de botï¿½es na segunda coluna do painel geral
		painel.add(painelBotao,g);								   //Adiciona o painel de botões ao painel principal com as configurações definidas por g
		
		return painel;											   //Retorna o painel com botões e titulos
	}
